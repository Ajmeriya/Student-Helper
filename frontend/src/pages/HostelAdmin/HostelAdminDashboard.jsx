...
import { FaUniversity, FaPlus, FaComments, FaUserEdit } from 'react-icons/fa'
      ...
      if (response.ok) {
        ...
        if (data.success) {
          ...
          setStats({
            ...
            activeListings: activeHostels.length,
            totalInquiries: 0 // TODO: Add message count endpoint
          })
        }
      }
    } catch (error) {
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <p className="text-3xl font-bold text-primary-600">{stats.totalHostels}</p>
              </div>
              <div>
