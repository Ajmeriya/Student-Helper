...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public Page<ItemResponse> getAllItems(ItemFilterRequest filters, Pageable pageable) {
    ...
    @Override
    public ItemResponse updateItemStatus(Long id, String status, Long sellerId) {
        Item item = itemRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Item not found"));
        ...
        try {
            item.setStatus(Item.ItemStatus.valueOf(status.toLowerCase()));
        } catch (IllegalArgumentException e) {
            throw new RuntimeException("Invalid status. Allowed values: available, sold, reserved");
        }
